...
本笔记基于项目论文库中的 37 份 PDF 及 5 项针对教育落地场景的前沿补充技术整理，共覆盖 42 项独立研究与工程方案。正文统一引用正式版编号 `[P28]`（原 `P24` 为 arXiv 预印本，`P28` 为 Findings of ACL 2025 正式版，保留 `P24` 为版本沿革记录）。新增精读与前沿扩展覆盖：
...
| P42 | OOXML / Deep PPT Parser | 原生 PPT 演讲者备注 (Notes) 提取与动态组件结构层级化 |
